...
\node[lbl, text=orange!80!black, right=0.1cm of mul_z] {$z$};
...
\node[lbl, text=orange!80!black] at (1.0, 1.1) {reset};
...
% ---- Reset gate → candidate (r_t gates h_{t-1} into tanh) ----
\draw[arr] (rg.south) -- (1.0, 0.2) -- (cand.west);
\node[lbl, text=orange!80!black] at (0.6, 0.9) {$r_t$};
