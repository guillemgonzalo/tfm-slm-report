...
\node[tok, minimum width=1.52cm, fill=orange!25] at (6.55*0.78, 1.6) {er};
\node[tok, fill=blue!12] at (8*0.78, 1.6) {m};
\node[tok, fill=blue!12] at (9*0.78, 1.6) {e};
\node[tok, minimum width=1.52cm, fill=orange!25] at (10.55*0.78, 1.6) {er};
\node[tok, fill=blue!12] at (12*0.78, 1.6) {s};
...
\node[tok, minimum width=1.52cm, fill=orange!25] at (6.30, 0.5) {er};
\node[tok, fill=blue!12] at (7.48, 0.5) {m};
\node[tok, fill=blue!12] at (8.26, 0.5) {e};
\node[tok, minimum width=1.52cm, fill=orange!25] at (9.44, 0.5) {er};
\node[tok, fill=blue!12] at (10.62, 0.5) {s};
