...
% block height = 1.4cm, node distance = 0.8cm
% center-to-center vertical distance = 0.7 + 0.8 + 0.7 = 2.2cm

\newcommand{\blockinnards}[1]{%
  \node[font=\scriptsize\bfseries, text=grucolor!80!black]
    at ([xshift=-1.6cm, yshift=-5pt]#1.center) {GRU};
  \node[font=\scriptsize, text=gray!40]
    at ([xshift=-0.65cm, yshift=-5pt]#1.center) {|};
  \node[font=\scriptsize\bfseries, text=mhacolor!80!black]
    at ([yshift=-5pt]#1.center) {MHA};
  \node[font=\scriptsize, text=gray!40]
    at ([xshift=0.65cm, yshift=-5pt]#1.center) {|};
  \node[font=\scriptsize\bfseries, text=mlpcolor!80!black]
    at ([xshift=1.6cm, yshift=-5pt]#1.center) {MLP};
}
