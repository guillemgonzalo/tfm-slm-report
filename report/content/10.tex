...
\begin{figure}[H]
    ...
    \caption{Escalado lineal del coste GPU en la instancia \texttt{g7e.2xlarge} (\$3,54/h). El punto verde marca el entrenamiento real (713M tokens, \$122); el punto rojo marca el umbral Chinchilla-optimal (3.340M tokens, \$571).}
