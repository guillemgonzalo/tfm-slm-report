...
\begin{figure}[H]
    ...
    \caption{Bloque Transformer estándar: Pre-LayerNorm seguida de Multi-Head Attention y MLP, con conexiones residuales. No incorpora componente recurrente ni memoria entre bloques.}
