...
El mecanismo de atención es invariante a la permutación: procesa el conjunto $\{e_1, \ldots, e_L\}$ sin noción de orden. Para dotar al modelo de información posicional, se añade un vector de codificación $p_t$ a cada embedding de entrada antes del primer bloque. La formulación sinusoidal original de Vaswani et al.~\cite{vaswani2017attention} define:
