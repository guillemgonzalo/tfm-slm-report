...
El analyzer se instancia en el trainer y se invoca cada \texttt{log\_metrics\_every} pasos (por defecto 100). Los archivos JSON se guardan en la instancia EC2 durante el entrenamiento; no persisten en el repositorio.
